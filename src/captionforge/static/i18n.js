...
window.CaptionForgeI18n = (() => {
  ...
  const DICT = {
    es: {
      ...
      uploadButtonQueue: "Generar subtítulos ({count} videos)",
      cancelJobButton: "Cancelar",
      selectedFile: "Archivo: {name}",
      queueHeading: "Cola de subida",
      queueStatusWaiting: "Esperando",
      queueStatusRunning: "Procesando",
      queueStatusDone: "Listo",
      queueStatusError: "Error",
      stageQueued: "En cola",
      stageExtracting: "Extrayendo audio",
      stageDownloadingModel: "Descargando modelo ({size}) ({percent}%)",
      stageTranscribing: "Transcribiendo ({percent}%)",
      stageReady: "Listo",
      stageBurning: "Quemando subtítulos ({percent}%)",
      stepExtracting: "Extraer audio",
      stepDownloading: "Descargar modelo",
      stepTranscribing: "Transcribir",
      stepDone: "Listo",
      modelDownloadTitle: "Descarga del modelo Whisper",
      modelDownloadBodyFirstTime: "El modelo \"{size}\" (~{sizeMb} MB) no está descargado todavía. Se descargará una sola vez a tu caché local y quedará listo para la próxima vez.",
      modelDownloadFreeDisk: "Espacio libre en disco: {freeGb} GB",
      modelDownloadRefused: "No hay espacio suficiente para descargar este modelo. Libera espacio en disco e inténtalo de nuevo.",
      modelDownloadCancel: "Cancelar",
      modelDownloadConfirm: "Descargar y continuar",
      ...
      editHint: "Corrige el texto si algo salió mal. Arrastra las marcas del inicio/fin sobre la forma de onda para ajustar los tiempos. Las palabras subrayadas tienen baja confianza de transcripción - revísalas.",
      ...
      wordConfidenceLowTitle: "Confianza de transcripción baja: {percent}%",
    ...
    en: {
      ...
      uploadButtonQueue: "Generate captions ({count} videos)",
      cancelJobButton: "Cancel",
      selectedFile: "File: {name}",
      queueHeading: "Upload queue",
      ...
      stageDownloadingModel: "Downloading model ({size}) ({percent}%)",
      stageTranscribing: "Transcribing ({percent}%)",
      stageReady: "Ready",
      stageBurning: "Burning subtitles ({percent}%)",
      stepExtracting: "Extract audio",
      stepDownloading: "Download model",
      stepTranscribing: "Transcribe",
      stepDone: "Done",
      modelDownloadTitle: "Whisper model download",
      modelDownloadBodyFirstTime: "The \"{size}\" model (~{sizeMb} MB) isn't downloaded yet. It'll be fetched once into your local cache and stay ready from then on.",
      modelDownloadFreeDisk: "Free disk space: {freeGb} GB",
      modelDownloadRefused: "There isn't enough disk space to download this model. Free up some space and try again.",
      modelDownloadCancel: "Cancel",
      modelDownloadConfirm: "Download and continue",
      resultsHeading: "Done",
      ...
      editHint: "Fix the text if something came out wrong. Drag the start/end marks over the waveform to adjust timing. Underlined words have low transcription confidence - double check them.",
      ...
      wordConfidenceLowTitle: "Low transcription confidence: {percent}%",
